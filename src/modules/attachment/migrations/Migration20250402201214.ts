...
export class Migration20250402201214 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table if not exists "attachment-pdf-template" ("id" text not null, "handle" text not null, "name" text not null, "template" jsonb not null, "pdfmeVersion" text not null, "created_at" timestamptz not null default now(), "updated_at" timestamptz not null default now(), "deleted_at" timestamptz null, constraint "attachment-pdf-template_pkey" primary key ("id"));`);
